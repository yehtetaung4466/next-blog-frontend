  ...
  return (
    <div className="w-screen h-screen flex justify-center items-center">
        <form className="form-control w-10/12 max-w-xs" onSubmit={handleSubmit}>
          ...
          <textarea value={content} onChange={e => setContent(e.target.value)} id="content" name="content" className="textarea textarea-bordered border-gray-500 focus:outline-none textarea-lg" />
          <div className="flex">
            <input type="file" accept="image/*" name="image" id="image" onChange={handleImageChange} />
          </div>
          <div className="flex">
            <input type="submit" value='create' className="btn btn-primary w-fit btn-xs mt-1" />
            <span className="mt-1">
